...
const Hero = () => {
  return (
    <div className="flex items-center sm:w-full justify-between lg:px-32 px-32 mt-20 md:px-14 sm:px-12 bg-background bg-no-repeat bg-left bg-[length:80%_100%] h-[75vh]">
       <div className='w-2/4'>
