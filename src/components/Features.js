            ...
            <div className="section-container mx-auto sm:p-0 ">
                ...
                border-t-orange gap-5 sm:gap-0 sm:w-11/12 py-20
                 md:py-14 md:px-2 px-7 sm:p-0 shadow-lg">
                    ...
                    <div className="content-box w-2/4 md:w-[55%] sm:w-[50%] mr-10 md:mr-3 sm:mr-3 mb-5">
                        <h2 className='text-2xl sm:text-sm py-8 mb-2 md:py-4 md:mb-2 sm:-mb-1 font-black'>تصميم الواجهات Ui/Ux</h2>
                        <p className="desc-text font-black pl-16 leading-loose md:leading-8 
                         text-lg md:text-sm sm:text-[10px] sm:font-normal -mt-4 md:pl-8 sm:pl-3">في هذه الدورة ندعوك لدخول عالم تصميم الواجهات لتطبيقات الهاتف 
                        ...
                        <div className="info flex justify-evenly sm:justify-around sm:w-full items-center ml-8 mt-4 md:-ml-1 md:pl-3 md:mr-0 sm:-mr-6">
                            <div className='border-l-4 md:border-l-3  sm:border-l-2 px-4 md:pl-3 sm:pl-4 leading-8
                             md:leading-5 text-center md:text-sm sm:text-[8px] sm:font-normal sm:leading-4 '>
                                <i className="fas fa-graduation-cap"></i>
                                <p>الفوج القادم </p>
                                <p> حزيران - تموز</p>
                            </div>
                            <div className='border-l-4  md:border-l-3 sm:border-l-2 px-4 md:px-2 sm:px-2 sm:-ml-1 leading-8 
                            md:leading-5 text-center md:text-sm sm:text-[8px] sm:leading-4  sm:font-normal'>
                                <i className="fas fa-hourglass-half"></i>
                                <p>مدة التخصص</p>
                                <p>4-5 أشهر</p>
                            </div>
                            <div className='px-2 md:px-2 sm:pl-1 sm:pr-2 leading-8 md:leading-5 sm:leading-4 
